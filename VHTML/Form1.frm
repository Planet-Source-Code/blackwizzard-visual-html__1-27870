...
cd1.Filter = "HTML (*.html)|*.html|Dynamique HTML (*.dhtml)|*.dhtml|shtml (*.shtml)|*.shtml"
cd1.ShowSave
...
pro.ondblclick.Enabled = True
pro.mouve.Enabled = True
pro.onload.Enabled = True
pro.onunload.Enabled = True
pro.onkeydown.Enabled = True
pro.onkeyup.Enabled = True
pro.onkeypress.Enabled = True
pro.onselect.Enabled = False
pro.onfocus.Enabled = False
pro.onchange.Enabled = False
pro.onblur.Enabled = False
...
pro.zout.Enabled = pro.out.Enabled
pro.zdown.Enabled = pro.down.Enabled
pro.Cheight.Text = zone.ScaleHeight - 5
pro.Cwidth.Text = zone.ScaleWidth - 5
pro.Ctop.Text = "N/A"
pro.Cleft.Text = "N/A"
End Sub
